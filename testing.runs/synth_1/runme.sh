...
HD_PWD='D:/RCLabProjects/testing/testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pc_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pc_block.tcl
